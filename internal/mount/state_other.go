...
func keepLocalPlatform(string) error {
	return fmt.Errorf("file availability controls require Windows CfAPI")
}
func releaseSpacePlatform(string) error {
	return fmt.Errorf("file availability controls require Windows CfAPI")
}
func onlineOnlyPlatform(string) error {
	return fmt.Errorf("file availability controls require Windows CfAPI")
}
