...
- The GitLab Windows runner remains a Windows shell runner using PowerShell with Go 1.25.x, Node.js 22, npm, Chocolatey, Windows CfAPI support, certificate creation/signing support, and permission to install/use Inno Setup.
